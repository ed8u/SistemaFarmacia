 ...
 * <p>Permite al usuario ingresar su correo y contraseña para autenticarse.
 * Si las credenciales son válidas, abre la ventana principal {@link Sistema}.</p>
 *
 * <p><b>Notas (solo comentarios, sin cambiar código):</b></p>
 * <ul>
 *   <li>Las credenciales por defecto se precargan en el constructor (solo para pruebas). <!-- TODO: retirar en producción --></li>
 *   <li>El modelo {@code login} usa contraseña en texto plano; considerar hash seguro y validaciones. <!-- TODO --></li>
 *   <li>Los enlaces a redes abren el navegador por defecto usando {@link Desktop#browse(URI)}. <!-- TODO: manejar errores/entorno sin GUI --></li>
 * </ul>
 *
 * @author Eduardo Jimenez
 */
public class Login extends javax.swing.JFrame {
    // Modelo para transportar los datos del usuario autenticado.
    login lg = new login();
    // DAO que realiza la verificación de credenciales contra BD.
    LoginDAO login = new LoginDAO();

    /**
     * Constructor de la ventana Login.
     * <p>Inicializa los componentes, centra la ventana y (por ahora) precarga
     * correo y contraseña de ejemplo.</p>
     */
    public Login() {
        initComponents();
        this.setLocationRelativeTo(null);
        // Valores de prueba (evitar en producción).
        txtCorreo.setText("admin@farmacialucmar.com");
     ...
     * <p>En caso contrario, notifica con un diálogo.</p>
     */
    public void validar() {
    // Normaliza entradas
    ...
    // Validación de campos vacíos (AND)
    ...
    // Condición correcta: usuario encontrado si id > 0 (o correo != null)
    if (lg.getId() > 0) {
    ...
    private void initComponents() {
        ...
        jPanel2.add(btnIniciar, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 240, 93, 34));
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/logo_pdf.jpg"))); // NOI18N
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 60, 100, 100));

        jLabel8.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 0, 0));
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel8.setText("Curso Integrador I: Sistemas Software");
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 190, 270, -1));

        jLabel9.setFont(new java.awt.Font("Segoe UI", 3, 14)); // NOI18N
        jLabel9.setText("Desarrollado por ");
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 230, -1, 40));

        jButton1.setForeground(new java.awt.Color(255, 255, 255));
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/UtpLogo.png"))); // NOI18N
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 320, 185, 50));
        ...
        jPanel1.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 20, 10, 380));

        jLabel10.setFont(new java.awt.Font("Segoe UI", 3, 14)); // NOI18N
        jLabel10.setText("Eduardo Manuel Jimenez Seclen");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 270, 220, 20));
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        // TODO add your handling code here:
        try {
            Desktop.getDesktop().browse(new URI(""));//FB
        } catch (IOException | URISyntaxException e1) {
        }
    ...
    private void jLabel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseClicked
        // TODO add your handling code here:
        try {
            Desktop.getDesktop().browse(new URI(""));//IG
        } catch (IOException | URISyntaxException e1) {
        }
